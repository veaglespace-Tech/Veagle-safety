            ...
            return (
              ...
              >
                ...
                <div className={`absolute top-0 left-0 right-0 h-2 ${
                  isFree ? 'bg-gradient-to-r from-emerald-400 to-teal-600' : 'bg-gradient-to-r from-[#FF5C8A] via-[#FF2A6D] to-[#E01A4F]'
                }`} />
                  ...
                  <div className="bg-[#FFF0F3] p-5 rounded-3xl border border-[#FFCCE1] flex items-center justify-between shadow-inner">
                    <div>
                      ...
                      <p className="text-[10px] text-[#684E67] font-extrabold mt-0.5">
                        {isFree ? 'Zero Charges' : `₹${(basePrice / 12).toFixed(1)}/month equivalent`}
                      </p>
                    </div>

                    <span className={`text-[10px] font-black px-3 py-1 rounded-full uppercase border shadow-xs ${
                      isFree
                  ...
                  <div className="space-y-3 pt-1">
                    ...
                    <div className="space-y-2.5">
                      {(plan.features && plan.features.length > 0
                        ...
                        <div key={idx} className="flex items-center space-x-2.5 text-xs font-bold text-[#2A0826]">
