...
import { Shield, Eye, EyeOff, Lock, Mail, Phone, User as UserIcon, ArrowRight, ShieldCheck, Sparkles, Crown } from 'lucide-react';
...
export const AuthPage: React.FC = () => {
  ...
  const [inputFocused, setInputFocused] = useState<'NONE' | 'EMAIL' | 'PASS' | 'NAME' | 'PHONE'>('NONE');
  ...
  const setDemoUser = (type: 'GIRL' | 'ADMIN') => {
    if (type === 'GIRL') {
  ...
  return (
    <div className="min-h-screen auth-mesh-bg flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10 space-y-5 animate-fade-up">
        ...
        {/* ONE-CLICK DEMO ROLE SWITCHER (For User & Boss) */}
