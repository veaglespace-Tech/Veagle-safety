...
export const ActiveSOSPage: React.FC = () => {
  ...
  const handleMarkSafe = async () => {
    ...
    if (success) { setShowConfirmSafeModal(false); navigate('/'); }
  };
    ...
    <div className="min-h-screen bg-tichi-emergency/5">
      ...
      <div className="max-w-xl mx-auto px-4 py-4 space-y-4 pb-12 lg:max-w-2xl">
        ...
        <div className="grid grid-cols-3 gap-2.5">
          {[
            { icon: MapPin, label: 'GPS Accuracy', value: `±${accuracy || '--'}m`, ok: true },
            { icon: Users, label: 'Notified', value: '3 Contacts', ok: true },
            { icon: Clock, label: 'Duration', value: formatElapsed(elapsed), ok: true },
          ].map((stat) => {
