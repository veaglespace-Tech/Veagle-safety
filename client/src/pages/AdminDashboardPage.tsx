...
export const AdminDashboardPage: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'INCIDENTS' | 'USERS' | 'SYSTEM'>('INCIDENTS');
  ...
  const handleAdminResolveSos = async (sosSessionId: string) => {
      ...
      <main className="max-w-7xl mx-auto px-4 py-6 space-y-6">
        ...
        {activeTab === 'INCIDENTS' && (
          <div className="space-y-4 animate-fade-up">
            ...
            {/* RECENT SOS INCIDENT LOGS TABLE */}
