...
export const ProfilePage: React.FC = () => {
  ...
  const diagnostics = [
    ...
    { icon: Smartphone, label: 'Device Vibration', status: 'vibrate' in navigator, value: 'vibrate' in navigator ? '✓ Supported' : '— Not Supported' },
  ];
      ...
      <div className="max-w-xl mx-auto px-4 pt-5 pb-6 space-y-4 lg:max-w-2xl">
        ...
        <div className="bg-white border border-blush-border rounded-2xl shadow-card overflow-hidden animate-fade-up">
          ...
          <div className="bg-gradient-to-br from-plum to-plum-dark h-24 relative">
            <div className="absolute inset-0 opacity-10" style={{ backgroundImage: 'radial-gradient(circle at 80% 50%, #E8A0BF 0%, transparent 60%)' }} />
          </div>
        ...
        <div className="bg-white border border-blush-border rounded-card shadow-card animate-fade-up">
          ...
          {[
            ...
            { label: 'About Tichi Suraksha', desc: 'Version 1.0.0 • Open source' },
          ].map((item) => (
            <button
              key={item.label}
