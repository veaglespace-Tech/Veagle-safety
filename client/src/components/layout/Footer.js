...
export const Footer = () => {
  return (
    <footer className="bg-white/95 backdrop-blur-xl border-t-1.5 border-[#FFCCE1] py-4 text-[#2A0826] shadow-sm relative z-20 w-full mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-4 text-xs font-extrabold text-[#684E67]">
        ...
        <div className="flex items-center space-x-4 text-[11px] font-black tracking-wide text-[#684E67] shrink-0">
        ...
        {/* RIGHT: DESIGNED & DEVELOPED BY (STRICT SINGLE LINE) */}
        <div className="flex items-center text-[10px] sm:text-[11px] font-black tracking-wide text-[#684E67] whitespace-nowrap shrink-0">
          <span>
