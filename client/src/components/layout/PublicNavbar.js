              ...
              <div className="hidden md:flex items-center gap-2.5">
                ...
                <MagneticButton pullStrength={0.4}>
                  <Link 
                    ...
                    className="group flex items-center gap-2 bg-gradient-to-r from-[#FF5C8A] to-[#FF2A6D] text-white text-xs font-black px-5 py-2.5 rounded-full shadow-md shadow-[#FF5C8A]/30 hover:shadow-xl hover:shadow-[#FF5C8A]/50 transition-all duration-300 active:scale-95"
                  >
